                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="traderlist-section search-result">
                        ...
                        <ul>
                            ...
                            <?php 
                            $reviewmodel = new App\Models\Reviews;
                            $reviews = $reviewmodel::where(['trader_id' => $value->id])->get();
                            ...
                            <li>
                                <a href="{{ route('traderdetails', $value->username) }}">
                                    <div class="result">
                                        ...
                                        <h5>{{ (count($reviews) > 0)?number_format(($avg_score/$total_reviews)/5,2):"0" }} <span>({{ (count($reviews) <= 1)?count($reviews)." Review":count($reviews)." Reviews" }})</span></h5>
