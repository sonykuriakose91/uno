                ...
                <div class="chat-main-sec">
                    <div class="chat-left">
                        ...
                        <div class="chat-list">
                            ...
                            <ul>
                                ...
                                <li class="chat-sec5 customer-message" data-user-type="{{ $message['user_type'] }}" data-user-id="{{ $message['user_id'] }}">
                    ...
                    <div class="chat-right">
                        ...
                        <div class="chating-sec">
                            ...
                            <div class="{{ ($message->from_user_type == 'customer' && $message->from_user_id == Auth::guard('web')->user()->user_id)?"myself":"friend"}}">
                            ...
                            <div class="chat-typing">
                                <form class="form-horizontal" autocomplete="off" id="message_from_message">
                                    ...
                                    <textarea placeholder="Write Somthing" required name="message" class="typing-sec"></textarea>
