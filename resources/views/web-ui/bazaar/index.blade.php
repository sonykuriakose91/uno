        ...
        <div class="row">
                ...
                <div class="bazaar-category mb-sec">
                    ...
                    <div class="category-links">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('bazaarbycategory',$category->id) }}">{{ $category->category }}</a></li>
                            @endforeach
                        </ul>
                        @endif
                    </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="bazaar-category">
                    <div class="category-head">Search Products <a href="#" {{ (Auth::guard('web')->check())?"data-toggle=modal data-target=#sellatbazaar":"onclick=openLoginModal('$url');" }}>Sell at Bazaar Now</a></div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="appointment-sec">
                                    ...
                                    <input type="file" required class="image-files" name="product_images[]" multiple>
                    ...
                    <div class="search-sec">
                        <form id="bazaar-search" method="POST">
                            @csrf
                            <div class="row">
                ...
                <div class="product-listing">
                    <div class="sort">
                        <div class="sort-sec">
                            <label>Sort : </label>
                            <select class="bazaar-product-sort">
