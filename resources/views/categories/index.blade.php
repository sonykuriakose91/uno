    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
              <a class="btn btn-success" style="float: right;" href="{{ route('categories.create') }}" title="Create Category">Add Category</a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover data_table">
                  ...
                  <tr>
                    <td>{{ ++$key }}</td>
                    <td>{{ ($value->main_category)?$value->main_category:"---" }} </td>
