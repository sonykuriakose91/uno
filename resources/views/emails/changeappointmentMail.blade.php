            ...
            <div style="width: 670px;padding: 33px 15px; float: left; background-image: url({{ asset('ui/email/images/bg.png') }}); background-repeat: repeat-x; background-position: left top;">
                <div style="width: 640px;float: left;background: #FFF;padding: 15px; border-radius: 6px;margin-bottom: 10px;">
                    ...
                    <div style="width: 100%;float: left;padding-top: 20px;">
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 18px;font-weight: bold;margin-bottom: 10px;">Dear {{ $changeappointment['trader'] }},</div>
                        <br/>
                        @if($changeappointment['status'] == "Cancelled")
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 14px;font-weight: normal;line-height: 24px;">Your appointment from {{ $changeappointment['customer'] }} has been cancelled.
                        </div>
                        <br/>
                        <br/>
						...
						@else
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 14px;font-weight: normal;line-height: 24px;">Your appointment from {{ $changeappointment['customer'] }} has been rescheduled.
                        </div>
                        <br/>
                        <br/>
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 14px;font-weight: normal;line-height: 24px;">Appointment Date - {{ $changeappointment['appointment_date'] }}
                        </div>
                        <br/>
                        <br/>
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 14px;font-weight: normal;line-height: 24px;">Appointment Time - {{ $changeappointment['appointment_time'] }}
                        </div>
                        <br/>
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 14px;font-weight: normal;line-height: 24px;">Remarks:{{ $changeappointment['remarks'] }}
                        </div>
