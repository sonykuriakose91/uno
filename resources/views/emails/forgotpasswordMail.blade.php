            ...
            <div style="width: 670px;padding: 33px 15px; float: left; background-image: url({{ asset('ui/email/images/bg.png') }}); background-repeat: repeat-x; background-position: left top;">
                <div style="width: 640px;float: left;background: #FFF;padding: 15px; border-radius: 6px;margin-bottom: 10px;">
                    ...
                    <div style="width: 100%;float: left;padding-top: 20px;">
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 18px;font-weight: bold;margin-bottom: 10px;">Dear {{ $reset_password['name'] }},</div>
                        <br/>
                        <div style="width: 100%;float: left;font-family: Arial, Helvetica, sans-serif;color: #231F20;font-size: 14px;font-weight: normal;line-height: 24px;">Please reset your password for the application by clicking on below:
                        </div>
                    </div>
                    <div style="width: 100%;float: left;padding-top: 20px;">
                        <div style="width: 100%;text-align: center;font-size: 12px; font-weight: bold;font-family: Arial, Helvetica, sans-serif;margin-bottom: 5px;text-decoration: none;">
                            <a href="{{ $reset_password['url'] }}" target="_blank" style="padding: 10px 30px;border-radius: 4px;background: #55AA47;color: #FFF;border: none;text-align: center;font-size: 14px;font-weight: 400;">Reset Password</a>
                        </div>
                    </div>
                </div>
