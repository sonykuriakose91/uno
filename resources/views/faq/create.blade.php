        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <form class="form-horizontal" autocomplete="off" action="{{ route('faq.store') }}" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control textarea" placeholder="Answer" required name="answer"></textarea>
                      </div>
                  </div>
                  <div class="form-group row">
